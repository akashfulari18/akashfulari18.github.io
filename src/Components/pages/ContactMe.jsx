...
{/* box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px; */}
      <Box  m="auto" mt="1rem" w={{base:"100%",sm:"90%",md:"50%",lg:"40%"}}>
 ...
 justifyContent={"left"} alignItems="center" >
      ...
      <Flex  borderTop={"2px solid red"}
      w="90%" m="auto"  justifyContent={"center"} fontSize={"2.5rem"} color={"white"} fontWeight="700">
        <Text fontSize={"1rem"} mt={"1rem"} color="white"> 
        Designed and build by Akash Fulari, 2023 All rights reserved.
        </Text>
      </Flex >
    </Box>
  );
