      ...
      <div className={abtStyle.abtMain}>
        ...
        <div className={abtStyle.abtContainer}>
          <div className={abtStyle.abtcard}>
            <div className={abtStyle.abtRight}>
              <div id="user-detail-intro" className={abtStyle.abtInfo}>
                A passionate Full Stack Developer with a proficiency in{" "}
                <span>React</span>, <span>Redux</span> ,<span> HTML</span> ,{" "}
                <span>CSS</span>,<span> JavaScript</span> ,{" "}
                <span> Node.js</span> ,<span>Typescript</span>,
                <span> Data Structures</span> and <span> Algorithm</span>.
          ...
          <div className={Style.myResContainer}>
                <a
                  id="resume-link-2"
                  href="https://drive.google.com/file/d/1xaMuGhFWKyH24monpvWCGU3Kc16e2Kai/view?usp=share_link"
                  rel="noreferrer"
                  target="_blank"
                >
                  <button >
                    Take a look at{' '}
                    <span className={Style.myRes}>My Resume</span>
                  </button>
                </a>
              </div>
        </div>
