      ...
      <Box  m="auto" mt="4rem" w={{base:"100%",sm:"90%",md:"50%",lg:"40%"}}>
        ...
        <Flex alignItems={"center"} >
          ...
          <Flex justifyContent={"left"} alignItems="center" >
            ...
            <Text>
              <a href="mailto:fulariakash007@gmail.com" target={"_blank"}>
          ...
          <Flex alignItems={"center"}>
            ...
            <Text>
              <a href="https://www.linkedin.com/in/akash-fulari-b57848190/" target={"_blank"}>
                <Text color={"red.500"} fontWeight="500" pl={"1rem"}>
          ...
          <Flex alignItems={"center"} >
            ...
            <Text>
              <a href="https://github.com/akashfulari18" target={"_blank"}>
                <Text color={"red.500"} fontWeight="500" pl={"1rem"}>
                  Akash_Fulari_Github
                </Text>
              </a>
